...
export default {
    ...
    argTypes: {
        ...
        isOpen: {
            control: "boolean",
            description:
                "Whether the popover is visible. Passing this prop puts the popover in controlled mode, where the only way to change visibility is by updating this property.",
        },
        interactionKind: {
            control: "select",
      ...
      */
        ...
        modifiers: {
            control: "object",
            description:
                "Popper modifier options, passed directly to internal Popper instance. See https://popper.js.org/docs/v2/modifiers/ for complete details.",
            table: {
                defaultValue: { summary: undefined },
        ...
        hasBackdrop: {
            control: "boolean",
            description:
                "Enables an invisible overlay beneath the popover that captures clicks and prevents interaction with the rest of the document until the popover is closed, only available with `PopoverInteractionKind.CLICK`.",
        },
        rootBoundary: {
            control: "select",
            options: { UNDEFINED: undefined, VIEWPORT: "viewport", DOCUMENT: "document" },
            description:
                "A root boundary element supplied to the `flip` and `preventOverflow` modifiers, shorthand for overriding Popper.js modifier options. See: https://popper.js.org/docs/v2/utils/detect-overflow/#rootboundary",
            table: {
