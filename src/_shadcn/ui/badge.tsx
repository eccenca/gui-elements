...
const badgeVariants = cva(
    // Default radius is `rounded-md` to match the gui-elements `Tag` atom (the app's dominant
    // badge shape); shadcn's stock `rounded-4xl` full-pill clashed with the ~60 rectangular
    // Tag/ArtefactTag badges across the app. Individual call sites can still override via className.
